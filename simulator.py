...
- DeterministicUserSimulator: fast attribute lookup for MCTS rollouts
- LLMUserSimulator: LLM-based natural language responses for evaluation
- ModelManager: generic HuggingFace model wrapper (used for both user and system LLMs)
"""
